...
http://home.agh.edu.pl/~mkuta/tklab/
   ...
   Gniazda      hljs.initHighlightingOnLoad(); [Przejdź do treści](http://home.agh.edu.pl/~rudek/so/Slides_10.html#content)
...
**Gniazda** (ang. _sockets_) są kolejnym z dostępnych mechanizmów komunikacji międzyprocesowej. W odróżnieniu od poznanych do tej pory (potoki, sygnały, komunikaty) obok komunikacji lokalnej umożliwiają również komunikację między procesami działającymi na różnych maszynach. Dostarczają nam warstwy abstrakcji nad fizycznym (światłowód, przewód miedziany, sieć bezprzewodowa) i logicznym (działanie protokołów sieciowych) sposobem połączenia maszyn.
...
Aby przekształcić zwykły numer portu do "network byte order" (w którym pierwszy bajt jest najbardziej znaczący), należy skorzystać z funkcji `[htobe16(…)](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions-htobeNN)` lub `[htons(…)](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions-htons)`.
...
### uint**NN**\_t htobe**NN**(uint**NN**\_t host\_**NN**bits)
...
### uint**NN**\_t htole**NN**(uint**NN**\_t host\_**NN**bits)
...
### uint**NN**\_t be**NN**toh(uint**NN**\_t big\_endian\_**NN**bits)
...
### uint**NN**\_t le**NN**toh(uint**NN**\_t little\_endian\_**NN**bits)
...
*   `domain` — jedna z [opisanych wcześniej stałych](http://home.agh.edu.pl/~rudek/so/Slides_10.html#properties-domain) określających rodzinę protokołów wykorzystywanych do komunikacji
*   `type` — jeden z [opisanych wcześniej trybów komunikacji](http://home.agh.edu.pl/~rudek/so/Slides_10.html#properties-type), ewentualnie zORowany z następującymi flagami:
...
*   `addr` — wskaźnik do [opisanej wcześniej struktury](http://home.agh.edu.pl/~rudek/so/Slides_10.html#addresses) definiującej adres z którym ma zostać związane gniazdo
...
### ssize\_t read(int sockfd, const void \*buf, size\_t len)  
ssize\_t recv(int sockfd, const void \*buf, size\_t len, int flags)  
ssize\_t recvfrom(int sockfd, const void \*buf, size\_t len, int flags, struct sockaddr \*src\_addr, socklen\_t \*addrlen)  
...
#### int epoll\_pwait(int epfd, struct epoll\_event \*events, int maxevents, int timeout, const sigset\_t \*sigmask)
...
[socket](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-socket)

[socket](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-socket)

[bind](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-bind)

[listen](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-listen)

[connect](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-connect)

[accept](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-accept)

powtarzające się [send](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-send)/[recv](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-recv)

powtarzające się [send](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-send)/[recv](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-recv)

[shutdown](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-shutdown)

[shutdown](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-shutdown)

[close](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-close)
...
[bind](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-bind) _(gdy uniksowe gniazdo datagramowe)_

[connect](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-connect)

powtarzające się [sendto](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-send)/[recvfrom](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-recv)
...
**Uwaga:** zgodnie z manualem — _This program is mostly obsolete. Replacement for netstat is ss._
...
*   W. Richard Stevens, Bill Fenner, Andrew M. Rudoff — _UNIX Network Programming: The Sockets Networking API_, tom 1
*   [UNIX Socket FAQ](http://www.unixguide.net/network/socketfaq/)
*   [The Linux man-pages project](https://www.kernel.org/doc/man-pages/)

*   [Wprowadzenie](http://home.agh.edu.pl/~rudek/so/Slides_10.html#introduction)
*   [Podstawowe cechy](http://home.agh.edu.pl/~rudek/so/Slides_10.html#properties)
    *   [Dziedzina](http://home.agh.edu.pl/~rudek/so/Slides_10.html#properties-domain)
    *   [Tryb komunikacji](http://home.agh.edu.pl/~rudek/so/Slides_10.html#properties-type)
    *   [Protokół](http://home.agh.edu.pl/~rudek/so/Slides_10.html#properties-protocol)
*   [Adresy gniazd](http://home.agh.edu.pl/~rudek/so/Slides_10.html#addresses)
    *   [AF\_INET](http://home.agh.edu.pl/~rudek/so/Slides_10.html#addresses-inet)
    *   [AF\_INET6](http://home.agh.edu.pl/~rudek/so/Slides_10.html#addresses-inet6)
    *   [AF\_UNIX](http://home.agh.edu.pl/~rudek/so/Slides_10.html#addresses-unix)
*   [Funkcje związane z adresami](http://home.agh.edu.pl/~rudek/so/Slides_10.html#address-functions)
    *   [inet\_aton](http://home.agh.edu.pl/~rudek/so/Slides_10.html#address-functions-inet_aton)
    *   [inet\_ntoa](http://home.agh.edu.pl/~rudek/so/Slides_10.html#address-functions-inet_ntoa)
    *   [inet\_pton](http://home.agh.edu.pl/~rudek/so/Slides_10.html#address-functions-inet_pton)
    *   [inet\_ntop](http://home.agh.edu.pl/~rudek/so/Slides_10.html#address-functions-inet_ntop)
    *   [gethostbyname](http://home.agh.edu.pl/~rudek/so/Slides_10.html#address-functions-gethostbyname)
    *   [gethostname](http://home.agh.edu.pl/~rudek/so/Slides_10.html#address-functions-gethostname)
*   [Funkcje związane z kolejością bajtów](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions)
    *   [htobeNN](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions-htobeNN)
    *   [htoleNN](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions-htoleNN)
    *   [beNNtoh](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions-beNNtoh)
    *   [leNNtoh](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions-leNNtoh)
    *   [htonl](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions-htonl)
    *   [htons](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions-htons)
    *   [ntohl](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions-ntohl)
    *   [ntohs](http://home.agh.edu.pl/~rudek/so/Slides_10.html#endianess-functions-ntohs)
*   [Funkcje do obsługi gniazd](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions)
    *   [socket](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-socket)
    *   [bind](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-bind)
    *   [listen](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-listen)
    *   [connect](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-connect)
    *   [accept, accept4](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-accept)
    *   [write, send, sendto, sendmsg](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-send)
    *   [read, recv, recvfrom, recvmsg](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-recv)
    *   [shutdown](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-shutdown)
    *   [close](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-close)
    *   [getsockname](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-getsockname)
    *   [setsockopt](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-setsockopt)
    *   [getsockopt](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-getsockopt)
    *   [socketpair](http://home.agh.edu.pl/~rudek/so/Slides_10.html#functions-socketpair)
*   [Monitorowanie wielu deskryptorów](http://home.agh.edu.pl/~rudek/so/Slides_10.html#monitor)
    *   [epoll](http://home.agh.edu.pl/~rudek/so/Slides_10.html#monitor-epoll)
    *   [poll](http://home.agh.edu.pl/~rudek/so/Slides_10.html#monitor-poll)
    *   [select](http://home.agh.edu.pl/~rudek/so/Slides_10.html#monitor-select)
*   [Typowy "cykl życia" gniazda](http://home.agh.edu.pl/~rudek/so/Slides_10.html#sequence)
    *   [Połączeniowe](http://home.agh.edu.pl/~rudek/so/Slides_10.html#sequence-connection)
    *   [Bezpołączeniowe](http://home.agh.edu.pl/~rudek/so/Slides_10.html#sequence-connectionless)
*   [Przydatne narzędzia](http://home.agh.edu.pl/~rudek/so/Slides_10.html#tools)
    *   [ss](http://home.agh.edu.pl/~rudek/so/Slides_10.html#tools-ss)
    *   [netstat](http://home.agh.edu.pl/~rudek/so/Slides_10.html#tools-netstat)
    *   [telnet](http://home.agh.edu.pl/~rudek/so/Slides_10.html#tools-telnet)
    *   [netcat](http://home.agh.edu.pl/~rudek/so/Slides_10.html#tools-netcat)
*   [Bibliografia](http://home.agh.edu.pl/~rudek/so/Slides_10.html#bibliography)

[Powrót na górę](http://home.agh.edu.pl/~rudek/so/Slides_10.html#top)
